...
AnimatedSpriteComponent::AnimatedSpriteComponent(Actor* pOwner, std::map <std::string, std::vector<Texture*>> pAnimations, std::string pCurrentAnimationName, int pDrawOrder, IRenderer::Flip pFlip) : SpriteComponent(pOwner, *pAnimations[pCurrentAnimationName][0], pFlip, pDrawOrder)
{
