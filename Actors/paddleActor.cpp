...
PaddleActor::PaddleActor(bool pSide, Window* pWindow)
{
	mWindow = pWindow;
...
void PaddleActor::MoveUp(float pDeltaTime, float mMultiplier)
{
...
void PaddleActor::MoveDown(float pDeltaTime, float mMultiplier)
{
	mRectangle->mPosition.y += mSpeed * mMultiplier * pDeltaTime;
...
void PaddleActor::FollowBall(float pBallYCoord, float pDeltaTime)
{
	// Check next movement
